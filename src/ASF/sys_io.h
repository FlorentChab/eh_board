...
#else
 #define	ROW_SR_D	PIN_PA09  //conflicts with SERCOM2 I2C SDA pin used on Xplained
 #define	ROW_SR_CLK	PIN_PA08  //conflicts with SERCOM2 I2C SCL pin used on Xplained
